...
'<div class="cbw-reset">
	<div class="cbw">
		<div id="cbw-widget" class="box-shadow cbw-widget-hide">
			<div id="cbw-heading">
				...
				<span id="cbw-welcome-user-message" class="cbw-widget-hide">Welcome&nbsp;
			...
			<div id="cbw-body-normal">
				<div id="cbw-pledge-title" class="cbw-widget-show">
					Pledge Title Placeholder
				</div>
				<div id="cbw-promo-text" class="cbw-body-text cbw-widget-show">
				...
				<div class="cbw-horiz-line cbw-widget-show"></div>
				<div class="cbw-currently-selected-cause cbw-widget-show">
				...
				<div class="cbw-horiz-line cbw-currently-selected-cause cbw-widget-show"></div>
				<div id="cbw-cause-selector" class="box-shadow">
					...
					<div id="cbw-cause-select-ctrl-grp" class="cbw-control-group cbw-widget-hide">
						...
						<div id="cbw-trending-cause-0" class="cbw-cause-radio-button-box cbw-widget-hide">
							<div class="cbw-radio-button">
						...
						<div  id="cbw-trending-cause-1" class="cbw-cause-radio-button-box cbw-widget-hide">
							<div class="cbw-radio-button">
						...
						<div  id="cbw-trending-cause-2" class="cbw-cause-radio-button-box cbw-widget-hide">
							<div class="cbw-radio-button">
				...
				<div id="cbw-channels-grp" class="cbw-control-group cbw-widget-show">
				...
				<div id="cbw-share-again" class="cbw-control-group share-again cbw-widget-hide">
				...
				<div class="email cbw-horiz-line cbw-widget-hide"></div>
				<div class="email cbw-widget-hide">
		        	...
		        	<div id="cbw-email-ctl-grp" class="cbw-control-group cbw-widget-hide">
						<div class="cbw-controls">
							<input id="cbw-email-input" type="text" placeholder="Enter your email address here." class="cbw-body-text">
							<div id="cbw-email-input-error-message" class="error cbw-widget-hide">Oops! Please correct email :)</div>
						</div>
					</div>
				</div>
	            <div id="cbw-share-msg-ctrl-grp" class="cbw-control-group cbw-widget-hide">
				...
				<div id="cbw-links" class="cbw-control-group">
	    			<div id="cbw-links-info-toggle" class="cbw-link cbw-widget-hide">more info</div>
	    			<a id="cbw-links-causebutton-url" class="cbw-link cbw-link-text"></a>
				</div>
				<div id="cbw-links-info" class="cbw-widget-hide cbw-control-group"" >
